    ...
    <body>
        ...
        <div id="navi">                        
            <ul id="menu">
                ...
                <li><a href="<%=request.getContextPath() %>/user/user_info.jsp" class="information_on"></a></li>
        ...
        <div id="main">            
           ...
           <!--  <div id="save_result_info" class="save_success">保存成功！</div>保存失败，数据并发错误！ -->  
            <form action="<%=request.getContextPath() %>/EditSelfManaUserServlet" method="post" class="main_form">
                <div class="text_info clearfix"><span>管理员账号：</span></div>
                <div class="input_info"><input type="text" value="${managerUser.managerName }" rreadonly="readonly" class="readonly" /></div>
                <div class="text_info clearfix"><span>角色：</span></div>
                <div class="input_info">
                    <input type="text" readonly="readonly" value="${managerUser.role }" class="readonly width400" />
                </div>
                <div class="text_info clearfix"><span>姓名：</span></div>
                <div class="input_info">
                    <input type="text" name="realName" value="${managerUser.realName }"/>
                    <span class="required">*必填</span>
                   <!--  <div class="validate_msg_long error_msg">20长度以内的汉字、字母的组合</div> -->
                </div>
                <div class="text_info clearfix"><span>电话：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="phoneNum" value="${managerUser.phoneNum }"/>
                    <span class="required">*必填</span>
                </div>
                <div class="text_info clearfix"><span>Email：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="email" value="${managerUser.email }"/>
                    <span class="required">*必填</span>
                </div>
                <div class="text_info clearfix"><span>上次登录时间：</span></div>
                <div class="input_info"><input type="text" value="${manaUserTime}" readonly="readonly" class="readonly" /></div>
                <div class="button_info clearfix">
                    <input type="submit" value="保存" class="btn_save" onclick="showResult();" />
                    <a href="<%=request.getContextPath()%>/ManaUserListServlet"><input type="button" value="取消" class="btn_save" /></a>
