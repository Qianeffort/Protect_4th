...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">      
            ...
            <form action="<%=request.getContextPath()%>/ModiManaUserPaServlet" method="post" class="main_form">
                <div class="text_info clearfix"><span>旧密码：</span></div>
                <div class="input_info">
                    <input type="password" class="width200" name="oldpassword" />
                    <span class="required">*</span>
                </div>
                <div class="text_info clearfix"><span>新密码：</span></div>
                <div class="input_info">
                    <input type="password"  class="width200" name="newpassword"/>
                    <span class="required">* 5-30以内长度的字母、数字和下划线的组合</span>
                </div>
                <div class="text_info clearfix"><span>重复新密码：</span></div>
                <div class="input_info">
                    <input type="password" class="width200" name="repeatpassword" />
                    <span class="required">* 两次新密码必须相同</span>
                </div>
